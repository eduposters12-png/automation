...
class User(Base):
    ...
    credit_cycle_start: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    credit_cycle_end: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    last_credit_reset: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
